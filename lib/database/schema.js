...
var Schema = module.exports = function(connection) {
  ...
  //This holds any ttl ( expiry ) details
  this._ttl = {};
...
Schema.prototype.registerCollection = function(collectionName, schema, meta) {
  ...
  if ( hasOwnProperty( meta ), "ttl"){
      this._ttl[name] = meta.ttl;
  }
...
Schema.prototype.recordKey = function(collectionName, index, key) {
  var name = collectionName.toLowerCase();
  var keyName = Utils.sanitize( key );
